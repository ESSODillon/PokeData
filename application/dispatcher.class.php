 ...
 * A typical url looks like this: http://example.com/PokeData/pokemon/view/1.
...
class Dispatcher
{
    ...
    public static function dispatch()
    {
        ...
        $controllerName = !empty($url_array[0]) ? ucfirst($url_array[0]) . 'Controller' : 'PokemonController';
